...
The tables can then be piped through subsequent customized processing with [`kableExtra`](https://cran.r-project.org/web/packages/kableExtra/vignettes/awesome_table_in_html.html) tools.
